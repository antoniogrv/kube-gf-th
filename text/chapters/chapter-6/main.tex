...
Un ampio spettro di sviluppi futuri è stato individuato nella cornice di questo lavoro di tesi. La pipeline di \glsname{ml} per i modelli GeneFusion può essere ulteriormente migliorata impiegato tecniche altamente sofisticate per garantire la distribuzione portabile del sistema come applicativo \glsname{kubernetes} via \glsname{helm}; la data governance via \glsname{fybrik}; e la resilienza e affidabilità della piattaforma con metodologie di \glsname{mlre}.
